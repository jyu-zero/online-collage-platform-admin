            ...
            setTimeout(() => {
                if(this.isMoveImg){
                    ...
                    if(y < (parentEle.offsetHeight - selectingCoverEle.offsetHeight) && y >= 0){
                        selectingPreEle.style.top = y + 1 + 'px'
                        selectingCoverEle.style.top = y + 1 + 'px'
                        selectingPreImgEle.style.top = -y - 1 + 'px'
                        showSelectingimgEle.style.top = -y - 1 + 'px'
                    }
                    if(x < (parentEle.offsetWidth - selectingCoverEle.offsetWidth) && x >= 0){
                        selectingPreEle.style.left = x + 1 + 'px'
                        selectingCoverEle.style.left = x + 1 + 'px'
                        selectingPreImgEle.style.left = -x - 1 + 'px'
                        showSelectingimgEle.style.left = -x - 1 + 'px'
                    }
                }
            }, 25)
        },
