...
export default {
    ...
    methods: {
        ...
        setImgSize(file, imgWidth, imgHeight){
            ...
            fileReader.onload = function() {
                ...
                img.onload = function() {
                    ...
                    vue.setShowImgDivSize(width, height)
                }
            }
        },
        setUploadImgSrc(src){
        ...
        setShowImgDivSize(width, height){
            ...
            for(let i = 0; i < uploadContentEle.length; i++){
                uploadContentEle[i].style.width = width + 'px'
                uploadContentEle[i].style.height = height + 'px'
            }
        }
    }
}
