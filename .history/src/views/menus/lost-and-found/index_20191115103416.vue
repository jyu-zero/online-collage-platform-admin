        ...
        moveSelectImg(event){
            setTimeout(() => {
                if(this.isMoveImg){
                    ...
                    if(isMoveBorder){
                        selectingPreEle.style.left = recordPrevPosition.x + 'px'
                        selectingCoverEle.style.left = recordPrevPosition.x + 'px'
                        selectingPreImgEle.style.left = -recordPrevPosition.x + 'px'
                        showSelectingimgEle.style.left = -recordPrevPosition.x + 'px'
                        selectingPreEle.style.top = recordPrevPosition.y + 'px'
                        selectingCoverEle.style.top = recordPrevPosition.y + 'px'
                        selectingPreImgEle.style.top = -recordPrevPosition.y + 'px'
                        showSelectingimgEle.style.top = -recordPrevPosition.y + 'px'
                    }
