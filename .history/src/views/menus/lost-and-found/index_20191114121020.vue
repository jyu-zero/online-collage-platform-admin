...
export default {
    ...
    methods: {
        ...
        setImgSize(file, imgWidth, imgHeight){
            ...
            let showHeight
            // 选中的图片大小
            let selectWidth = Math.ceil(showWidth / 2)
            ...
            fileReader.onload = function() {
                ...
                img.src = this.result
                img.onload = function() {
                    showHeight = Math.ceil((showWidth / img.width) * img.height)
                    vue.setUploadImgSrc(img.src).call(vue)
                    vue.setShowImgDivSize(showWidth, showHeight).call(vue)
                    vue.setSelectImgDivSize(selectWidth, selectHeight).call(vue)
                }
            }
        },
        setUploadImgSrc(src){
