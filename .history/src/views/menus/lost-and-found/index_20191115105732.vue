        ...
        moveSelectImg(event){
            setTimeout(() => {
                if(this.isMoveImg){
                    ...
                    if(gapLeft < 0){
                        selectingPreEle.style.left = 0 + 'px'
                        selectingCoverEle.style.left = 0 + 'px'
                        selectingPreImgEle.style.left = -0 + 'px'
                        showSelectingimgEle.style.left = -0 + 'px'
                    }else if(gapLeft >= 0 && gapWidth >= gapLeft){
                        selectingPreEle.style.left = x + 'px'
                        selectingCoverEle.style.left = x + 'px'
                        selectingPreImgEle.style.left = -x + 'px'
                        showSelectingimgEle.style.left = -x + 'px'
