...
export default {
    ...
    methods: {
         ...
         * y: 截取开始的Y坐标
         */
        cutOutImg(imgSrc, width, height, startX, starty){
            ...
            bufferImg.getContext('2d').drawImage(originalImg, 0, 0, originalImg.width, originalImg.height)
            destCtx.drawImage(originalImg, startX, starty, width, height, 0, 0, width, height)
            // 返回base64图片类型
            return bufferImg.toDataURL()
        },
