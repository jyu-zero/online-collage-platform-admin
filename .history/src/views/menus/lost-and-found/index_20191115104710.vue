        ...
        moveSelectImg(event){
            setTimeout(() => {
                if(this.isMoveImg){
                    ...
                    let posa = this.getPos(parentEle, event)
                    let a = posa.x - this.divPos.x
                    let b = posa.y - this.divPos.y
                    if(b < (parentEle.offsetHeight - selectingCoverEle.offsetHeight) && b >= 0){
                    ...
                    if(a < (parentEle.offsetWidth - selectingCoverEle.offsetWidth) && a >= 0){
