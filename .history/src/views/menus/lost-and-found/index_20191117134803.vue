...
export default {
    ...
    methods: {
         ...
         * y: 截取开始的Y坐标
         */
        cutOutImg(imgSrc, destWidth, destHeight, startX, starty, originalWidth, originalHeight){
            ...
            bufferImg.width = originalWidth
            bufferImg.height = originalHeight
            bufferImg.getContext('2d').drawImage(originalImg, 0, 0)
            destCtx.drawImage(bufferImg, startX, starty, originalWidth, originalHeight, 0, 0, destWidth, destHeight)
            // 返回base64图片类型
