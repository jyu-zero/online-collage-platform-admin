...
export default {
    ...
    methods: {
         ...
         * y: 截取开始的Y坐标
         */
        cutOutImg(imgSrc, destWidth, destHeight, startX, starty){
            ...
            bufferImg.width = this.showImgSize.width
            bufferImg.height = this.showImgSize.height
            bufferImg.getContext('2d').drawImage(originalImg, 0, 0, originalImg.width, originalImg.height, 0, 0, this.showImgSize.width, this.showImgSize.height)
            destCtx.drawImage(bufferImg, startX, starty, destWidth, destHeight, 0, 0, destWidth, destHeight)
            // 返回base64图片类型
            return destCtx.toDataURL()
        },
