                            ...
                            <div class="lost-upload">
                                <div class="upload-content"
                                    ...
                                    <div class="select-size"
                                         ...
                                         :style="{'width': divSize.width + 'px', 'height': divSize.height + 'px',
                                         'left': imgPosition.left + 'px', 'top': imgPosition.top + 'px'}">
                                        <span id="top-left-btn" @mousedown="beginSetDivSize" @mousemove="setDivSize"></span>
                                        <span id="top-right-btn" @mousedown="beginSetDivSize" @mousemove="setDivSize"></span>
                                        <span id="bottom-left-btn" @mousedown="beginSetDivSize" @mousemove="setDivSize"></span>
                                        <span id="bottom-right-btn" @mousedown="beginSetDivSize" @mousemove="setDivSize"></span>
                                    </div>
                                </div>
                                <div class="line"></div>
                                <div class="show-wrap">
