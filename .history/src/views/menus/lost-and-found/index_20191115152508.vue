                    ...
                    <div class="content-body">
                        ...
                        <div class="upload-lost-img" @mouseup="endMoveImg">
                            ...
                            <div class="lost-upload">
                                <div class="upload-content" :style="{'width': showImgSize.width,
                                                                     'height': showImgSize.height}">
                                    <img :src="uploadImgSrc" alt="">
                                    <div class="select-size" id="selecting-pre">
                                        <img :src="uploadImgSrc"
                                                    class="show-bg"
                                                    alt=""
                                                    :style="{'width': showImgSize.width,
                                                    'height': showImgSize.height}">
                                    </div>
                                ...
                                <div class="show-wrap">
                                    <div class="upload-content select-size" id="show-selecting">
                                        <img :src="uploadImgSrc" :data-c="showImgSize[0].width + 'px'" :style="{'width': showImgSize.width + 'px',
                                                                         'height': showImgSize.height + 'px'}" alt="">
                                    </div>
                                </div>
                            </div>
        ...
        setDivSize(event){
            if(this.isDivImgSize){
                ...
                setTimeout(() => {
                    ...
                    let width = this.divSize.width + posX
                    let height = this.divSize.height + posY
                    let gapLeft = selectingCoverEle.offsetLeft
                    let gapTop = selectingCoverEle.offsetTop
                    let gapWidth = parentEle.offsetWidth - selectingCoverEle.offsetWidth
                    let gapHeight = parentEle.offsetHeight - selectingCoverEle.offsetHeight
                    ...
                    if(gapWidth < gapLeft){
                        width = this.divSize.width - 1
                    }
                    if(gapHeight < gapTop){
                        height = this.divSize.height - 1
                    }

                    selectingPreEle.style.width = width + 'px'
                    selectingPreEle.style.height = height + 'px'
                    selectingCoverEle.style.width = width + 'px'
                    selectingCoverEle.style.height = height + 'px'
                    showSelectingimgEle.style.width = width + 'px'
                    showSelectingimgEle.style.height = height + 'px'
                    this.divSize = {
                        width,
                        height
                    }
                    console.log(selectingCoverEle.offsetBottom)
                    this.divBtnPos = pos
                }, 10)
            }
        },
