                            ...
                            <div class="lost-upload" v-if="isUploadImg">
                                ...
                                <div class="show-wrap">
                                    <div class="upload-content select-size" id="show-selecting"
                                        :style="{'width': previewDivSize.width + 'px', 'height': previewDivSize.height + 'px'}">
                                        <img :src="uploadImgSrc"
                                            :style="{'width': previewImgSize.width + 'px','height': previewImgSize.height + 'px',
                                            'left': -imgPosition.left + 'px', 'top': -imgPosition.top + 'px'}"
                                            alt="">
                                    </div>
                                    <p>预览图片</p>
        ...
        setDivSize(event){
            if(this.isDivImgSize){
                ...
                setTimeout(() => {
                    ...
                    let previewImgHeight = this.previewImgSize.height
                    let previewImgWidth = this.previewImgSize.width
                    let gap = this.getDivPos(selectingCoverEle)
                    let gapWidth = parentEle.offsetWidth - selectingCoverEle.offsetWidth
                    let gapHeight = parentEle.offsetHeight - selectingCoverEle.offsetHeight
                    let x, y
                    ...
                    switch(this.setDivDirection){
                        case 'top-left':
                            if(gap.left >= 0 && gap.top >= 0){
                                ...
                                y = posY + this.imgPosition.top
                                width = this.divSize.width - posX
                                height = this.divSize.height - posY
                                previewImgWidth = this.previewImgSize.width - posX
                                previewImgHeight = this.previewImgSize.height - posX
                                this.imgPosition = {
                                    left: x,
                                    top: y
                                }
