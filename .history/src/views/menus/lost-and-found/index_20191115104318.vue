            ...
            <div class="position-all curtain-black" id="search-lost" style="display: none">
                <div class="content">
                    ...
                    <div class="content-body">
                        <!-- 上传丢失物图片 [开始]] -->
                        <div class="upload-lost-img" @mouseup="endMoveImg">
                            ...
                            <div class="lost-upload">
                                <div class="upload-content">
                                    ...
                                    <div class="select-size"
                                        ...
                                        <span id="bottom-right-btn" @mousedown="beginSetDivSize" @mousemove="setDivSize" @mouseup="endSetDivSize"></span>
                                    </div>
                                </div>
                                <div class="line"></div>
                                <div class="show-wrap">
        ...
        moveSelectImg(event){
            setTimeout(() => {
                if(this.isMoveImg){
                    ...
                    let showSelectingimgEle = document.getElementById('show-selecting').firstElementChild
                    // 子元素离父元素的距离(类似offsetLeft)
                    // let gap = this.getPos(parentEle, event)
                    // let x = pos.x - this.divPos.x
                    // let y = pos.y - this.divPos.y
                    ...
                    //     showSelectingimgEle.style.top = -y + 'px'
                    // }
                    ...
                    //     showSelectingimgEle.style.left = -x + 'px'
                    // }
                    ...
                    let gapLeft = selectingCoverEle.offsetLeft
                    let gapTop = selectingCoverEle.offsetTop
                    ...
                    let recordPrevPosition = this.recordPrevPosition
                    let isMoveBorder = false

                    if(gapLeft >= 0 && gapWidth > gapLeft){
                        selectingPreEle.style.left = x + 'px'
                        selectingCoverEle.style.left = x + 'px'
                        selectingPreImgEle.style.left = -x + 'px'
                        showSelectingimgEle.style.left = -x + 'px'
                    }
                    if(gapTop >= 0 && gapHeight > gapTop){
                        selectingPreEle.style.top = y + 'px'
                        selectingCoverEle.style.top = y + 'px'
                        selectingPreImgEle.style.top = -y + 'px'
                        showSelectingimgEle.style.top = -y + 'px'
                    }else if(gapTop < 0){
                        selectingPreEle.style.top = 0 + 'px'
                        selectingCoverEle.style.top = 0 + 'px'
                        selectingPreImgEle.style.top = -0 + 'px'
                        showSelectingimgEle.style.top = -0 + 'px'
                    }
                    this.imgPosition = {
                        left: x,
                        top: y
                    ...
                    if(isMoveBorder){
                        selectingPreEle.style.left = recordPrevPosition.left + 'px'
                        selectingCoverEle.style.left = recordPrevPosition.left + 'px'
                        selectingPreImgEle.style.left = -recordPrevPosition.left + 'px'
                        showSelectingimgEle.style.left = -recordPrevPosition.left + 'px'
                        selectingPreEle.style.top = recordPrevPosition.top + 'px'
                        selectingCoverEle.style.top = recordPrevPosition.top + 'px'
                        selectingPreImgEle.style.top = -recordPrevPosition.top + 'px'
                        showSelectingimgEle.style.top = -recordPrevPosition.top + 'px'
                        console.log(recordPrevPosition)
                    }
                }
            }, 25)
        },
        ...
        setDivSize(event){
            if(this.isDivImgSize){
                ...
                setTimeout(() => {
                    let selectingPreEle = document.getElementById('selecting-pre')
                    let selectingCoverEle = document.getElementById('selecting-cover')
                    let showSelectingimgEle = document.getElementById('show-selecting')
                    let pos = this.getMousePos(event)
                    let posX = (pos.x - this.divBtnPos.x)
                    let posY = (pos.y - this.divBtnPos.y)
                    let x = this.divSize.width + posX
                    let y = this.divSize.height + posY

                    selectingPreEle.style.width = x + 'px'
                    selectingPreEle.style.height = y + 'px'
                    selectingCoverEle.style.width = x + 'px'
                    selectingCoverEle.style.height = y + 'px'
                    showSelectingimgEle.style.width = x + 'px'
                    showSelectingimgEle.style.height = y + 'px'
                    this.divSize = {
                        width: x,
                        height: y
                    }
