        ...
        moveSelectImg(event){
            setTimeout(() => {
                if(this.isMoveImg){
                    ...
                    let aa = parseInt(selectingPreEle.style.top) + y + 'px'
                    if(y < (parentEle.offsetHeight - selectingCoverEle.offsetHeight) && y >= 0){
                        selectingPreEle.style.top = aa
                        selectingCoverEle.style.top = aa
                        selectingPreImgEle.style.top = aa
                        showSelectingimgEle.style.top = aa
                    }
