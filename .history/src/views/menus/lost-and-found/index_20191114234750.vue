                            ...
                            <div class="lost-upload">
                                <div class="upload-content">
                                    ...
                                    <div class="select-size"
                                        ...
                                        <span id="top-left-btn"  @mousedown="beginSetDivSize" @mousemove="setDivSize" @mouseup="endSetDivSize"></span>
    ...
    methods: {
        ...
        setDivSize(event){
            if(this.isDivImgSize){
                ...
                let x = pos.x - this.divBtnPos.x
                let y = pos.y - this.divBtnPos.y
                if(x < 0){
                    selectingPreEle.style.width = this.divSize.width + x + 'px'
                    selectingPreEle.style.height += this.divSize.height + y + 'px'
                    selectingCoverEle.style.width = this.divSize.width + x + 'px'
                    selectingCoverEle.style.height += this.divSize.height + y + 'px'
                    showSelectingEle.style.width = this.divSize.width + x + 'px'
                    showSelectingEle.style.height += this.divSize.height + y + 'px'
                    selectingPreEle.style.left = this.divSize.width + x + 'px'
                    selectingCoverEle.style.left = this.divSize.width + x + 'px'
                    selectingPreImgEle.style.left = this.divSize.width + (-x) + 'px'
                    showSelectingimgEle.style.left = this.divSize.width + (-x) + 'px'
                }
            }
        },
        endSetDivSize(){
