            ...
            setTimeout(() => {
                if(this.isMoveImg){
                    ...
                    if(x < (parentEle.offsetWidth - selectingCoverEle.offsetWidth) && x >= 0){
                        selectingPreEle.style.left = parseInt(selectingPreEle.style.top) + x + 'px'
                        selectingCoverEle.style.left = parseInt(selectingPreEle.style.top) + x + 'px'
                        selectingPreImgEle.style.left = parseInt(selectingPreEle.style.top) + (-x) + 'px'
                        showSelectingimgEle.style.left = parseInt(selectingPreEle.style.top) + (-x) + 'px'
                    }
