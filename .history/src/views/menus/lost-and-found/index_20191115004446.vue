            ...
            setTimeout(() => {
                if(this.isMoveImg){
                    ...
                    if(y < (parentEle.offsetHeight - selectingCoverEle.offsetHeight) && y >= 0){
                        ...
                        selectingCoverEle.style.top = parseInt(selectingPreEle.style.top) + y + 'px'
                        selectingPreImgEle.style.top = -parseInt(selectingPreEle.style.top) + -y + 'px'
                        showSelectingimgEle.style.top = -parseInt(selectingPreEle.style.top) + -y + 'px'
                    }
                    if(x < (parentEle.offsetWidth - selectingCoverEle.offsetWidth) && x >= 0){
                        ...
                        selectingCoverEle.style.left = parseInt(selectingPreEle.style.left) + x + 'px'
                        selectingPreImgEle.style.left = parseInt(selectingPreEle.style.left) + (-x) + 'px'
                        showSelectingimgEle.style.left = parseInt(selectingPreEle.style.left) + (-x) + 'px'
                    }
                    this.divBtnPos = pos
                    console.log(parseInt(selectingPreEle.style.top) + x + 'px')
                }
            }, 25)
        },
        beginMoveImg(event){
